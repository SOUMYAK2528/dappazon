...
//global variable declared for list attributes
...
describe("Dappazon", () => {
  ...
  describe("Listing", () => {
    ...
    it(' check the item attributes ', async () => {
  ...
  describe("Buying", () => {
    ...
    it('it updates the contract balance', async () => {
  ...
  describe("Withdrawing", () => {
    ...
    it('Updates the balane after' , async()=>{
